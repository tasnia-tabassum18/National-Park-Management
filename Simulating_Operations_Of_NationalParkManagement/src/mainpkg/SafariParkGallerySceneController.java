 ...
 * @author ASUS
 */
public class SafariParkGallerySceneController implements Initializable {
    ...
    private void gobackButtonOnClick(ActionEvent event) {
        //go back button is clicked on safari park gallery and tourist scene is loaded
         try {
            System.out.println("going back to tourist dashboard from safaripark");
