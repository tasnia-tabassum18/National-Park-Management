 ...
 * @author ASUS
 */
public class RestaurantGalleryController implements Initializable {
    ...
    private void gobackButtonOnClick(ActionEvent event) {
           //goes back to tourist dashboard from rest. gallery on button click
        try {
            System.out.println("going back to tourist dashboard from restaurant gallery");
