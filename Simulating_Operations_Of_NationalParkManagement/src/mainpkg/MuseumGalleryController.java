 ...
 * @author ASUS
 */
public class MuseumGalleryController implements Initializable {
    ...
    private void goBackButtonOnClick(ActionEvent event) {
        //goes back to tourist dashboard from musem gallery on button click
        try {
            System.out.println("going back to tourist dashboard from musem");
